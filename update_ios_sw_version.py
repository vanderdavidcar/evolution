...
while True:
    prompt1=input('You want to update sw_version? Type "yes" or "no" ').lower()
    ...
    if prompt1 == 'yes':
       ...
       for devices in ios_model:
        # Delete custom fields "sw_version" using regex information collected
        dict(devices)['custom_fields']["sw_version"] = ""
        devices.save()
        #break
